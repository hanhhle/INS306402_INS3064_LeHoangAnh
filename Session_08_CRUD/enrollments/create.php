...
<!DOCTYPE html>
<html lang="vi">
<head><meta charset="UTF-8"><title>Thêm đăng ký học</title></head>
<body>
...
<form method="post">
    <div>
        ...
        <?php if (!empty($errors['student_id'])): ?><span style="color: red;"><?= htmlspecialchars($errors['student_id']) ?></span><?php endif; ?>
    </div><br>
    ...
    <div>
        ...
        <?php if (!empty($errors['course_id'])): ?><span style="color: red;"><?= htmlspecialchars($errors['course_id']) ?></span><?php endif; ?>
    </div><br>
