...
<p><a href="../courses/index.php">Chuyển sang module Khóa học</a> | <a href="../enrollments/index.php">Chuyển sang module Ghi danh</a></p>

<?php if ($successMessage): ?>
    <p style="color: green;"><?= htmlspecialchars($successMessage) ?></p>
<?php endif; ?>

<p><a href="create.php" class="btn btn-add">+ Thêm sinh viên</a></p>

<table>
    <tr><th>ID</th><th>Họ tên</th><th>Email</th><th>Ngày tạo</th><th>Hành động</th></tr>
